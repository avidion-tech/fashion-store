    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-light mb-4 tracking-tight">BEST SELLERS</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our most loved pieces that define contemporary luxury
          </p>
        </div>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden bg-gray-100 aspect-[3/4] mb-4">
                ...
                {/* Best Seller Badge */}
                <span className="absolute top-4 left-4 bg-gold-500 text-white px-3 py-1 text-xs font-medium tracking-wide">
                  BEST SELLER
                </span>
