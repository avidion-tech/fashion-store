export const products = [
  // Women's Collection
  {
    ...
    description: 'Elegant and versatile white shirt perfect for both office and casual wear. Made from premium cotton blend.',
    isNew: false,
    isSale: true
  },
  {
  ...
  },
  {
    ...
    description: 'Comfortable high-waist jeans with a flattering fit. Perfect for everyday wear.',
    isNew: false,
    isSale: true
  },
  {
    ...
    description: 'Luxurious silk blouse for special occasions. Elegant and sophisticated design.',
    isNew: true,
    isSale: false
  },
  {
    ...
    price: 2799,
    images: [
      'https://images.unsplash.com/photo-1583496661160-fb5886a13d44?w=500',
      'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=500'
    ],
    category: 'women',
    subcategory: 'bottoms',
    ...
    description: 'Classic pleated midi skirt that pairs well with any top. Versatile and timeless.',
    isNew: false,
    isSale: false
  },
  ...
  },
  {
    ...
    description: 'Elegant formal blazer crafted from premium fabric. Perfect for business meetings and formal events.',
    isNew: true,
    isSale: false
  },
  {
    ...
    description: 'Comfortable chino pants suitable for both casual and smart-casual looks.',
    isNew: false,
    isSale: false
  },
  {
    ...
    description: 'Classic denim jacket with a modern fit. A wardrobe essential for layering.',
    isNew: false,
    isSale: true
  },
  {
    ...
    description: 'Breathable linen shirt perfect for summer. Relaxed fit with a comfortable feel.',
    isNew: true,
    isSale: false
  },
  ...
  // Accessories
  {
    ...
    description: 'Premium leather handbag with multiple compartments. Perfect for everyday use.',
    isNew: false,
    isSale: true
  },
  {
    ...
    description: 'Elegant classic watch with leather strap. Timeless design that complements any outfit.',
    isNew: true,
    isSale: false
  },
  {
  ...
  // New Collection
  {
    ...
    description: 'Comfortable athletic hoodie perfect for workouts and casual wear.',
    isNew: true,
    isSale: false
  },
  {
